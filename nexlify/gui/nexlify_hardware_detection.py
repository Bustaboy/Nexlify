...
class HardwareDetector:
    ...
    def detect_all(self):
        ...
        logger.info(
            f"✅ Hardware detection complete - Profile: {self.performance_profile}"
        )
    ...
    def detect_cpu(self):
        ...
        try:
            ...
            logger.info(
                f"CPU: {self.hardware_info['cpu']['cores_physical']} cores, "
    ...
    def detect_memory(self):
        ...
        try:
            ...
            logger.info(
                f"RAM: {self.hardware_info['memory']['total_gb']:.1f} GB total, "
        ...
        try:
            ...
            try:
                ...
                if result.returncode == 0:
                    ...
                    gpu_info["gpu_names"] = [
                        line.split(",")[0].strip() for line in gpu_lines
                    ]
            ...
            if gpu_info["gpu_count"] > 0:
                logger.info(
                    f"GPU: {gpu_info['gpu_count']} detected - {', '.join(gpu_info['gpu_names'])}"
                )
            else:
    ...
    def detect_storage(self):
        ...
        try:
            ...
            logger.info(
                f"Storage: {self.hardware_info['storage']['free_gb']:.1f} GB free "
                f"({storage_type})"
            )
    ...
    def _detect_storage_type(self) -> str:
        ...
        try:
            ...
            # macOS - NVMe is typically SSD
                ...
                result = subprocess.run(
                    ["diskutil", "info", "disk0"], capture_output=True, text=True
                )
    ...
    def apply_optimal_settings(self, config_path: str = "config/neural_config.json"):
        ...
        try:
            ...
            config["trading"]["max_concurrent_trades"] = recommended[
            ...
            config["neural_net"]["scan_interval_seconds"] = recommended[
            ...
            config["hardware_profile"] = {
                "detected": True,
                "profile": self.performance_profile,
                "detection_date": logger.Formatter().formatTime(
            ...
            logger.info(
                f"✅ Applied {self.performance_profile} settings to configuration"
            )
            return True
