    ...
    async def test_shutdown_all_trading(self, kill_switch):
        ...
        for exchange in exchanges.values():
            if hasattr(exchange, 'cancel_all_orders'):
                assert exchange.cancel_all_orders.called or not exchange.cancel_all_orders.called
...
class TestIntegration:
    ...
    async def test_cascading_failure_protection(self):
        ...
        kill_config = {'emergency_kill_switch': {'enabled': True, 'max_daily_loss_percent': 10.0}}
        kill_switch = EmergencyKillSwitch(kill_config)
...
class TestEdgeCases:
    ...
    def test_zero_price_crash_detection(self):
        ...
        config = {'flash_crash_protection': {'enabled': True, 'price_drop_threshold': 10.0}}
